...
Can you solve this real interview question? Maximum Binary Tree II - A maximum tree is a tree where every node has a value greater than any other value in its subtree.
